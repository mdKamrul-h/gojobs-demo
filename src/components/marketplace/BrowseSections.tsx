...
const LOCATIONS = [
  { division: "dhaka", label: "Dhaka" },
  { division: "chittagong", label: "Chittagong" },
  { division: "dhaka", district: "gazipur", label: "Gazipur" },
];
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-wrap gap-3">
          {CATEGORIES.map(({ occupation, icon }) => (
            <Link
              key={occupation}
              href={`/jobs?occupation=${occupation}`}
            >
              <Badge
                variant="outline"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-3">
            {LOCATIONS.map((loc) => {
              ...
              return (
                <Link key={loc.label} href={`/jobs?${params.toString()}`}>
                  <Badge
                    variant="secondary"
